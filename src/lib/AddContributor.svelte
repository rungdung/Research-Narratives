...
{#if formModal}
	<Card class="bg-primary-100 absolute min-w-[15vw]  origin-top-right z-50 bg-opacity-100 drop-shadow-md">
		...
		<form action="?/addContributor" method="post" use:enhance bind:this={form}>
			<div class="mb-6">
				...
				<Helper class="text-xs mt-2 text-gray-500">If such an account does not exist already, they will get an invitation email. You will have to reenter their email after their account is created.</Helper>
			</div>
		</form>
