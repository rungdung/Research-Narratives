<script>
	...
	import { Accordion, AccordionItem, Button, Label, Input } from 'flowbite-svelte';
	import { loadToDB } from '$lib/utils/loadToDB.mjs';
	...
	let dataConnectionsCopy = JSON.parse(JSON.stringify(annotationNode.dataConnections));
	...
	<div class="node" use:grabHandle>
		...
		<span class="anchor-right">
			<Anchor
				...
				output
			>
				<CustomAnchor {hovering} {connecting} {linked} label="Images" color="red-600" />
			</Anchor>
		</span>
	</div>
</Node>
