<script>
	...
	import { addNewNarrativeNode } from '$lib/utils/addNewNodes.mjs';
...
<Node id={node.id} {...node}>
	{#if node.id != 'narrativeNode-0'}
		<div class="node-wrapper">
			...
			<Label for="section-title" class="mb-0 !text-blac">Provide a title for the section</Label>
			<Textarea
			...
			<section id="inputs" class="space-y-2 my-4">
				<Anchor
					...
					key="narrativeData"
				>
					<CustomAnchor {hovering} {connecting} {linked} label="Spatial Feature" />
				</Anchor>
