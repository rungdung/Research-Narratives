...
<section class="bg-primary-50 text-black px-2 sm:px-10 md:w-3/4 md:mx-auto">
	...
	>
		<NavBrand href="/" class="justify-center w-full">
			<h1 class="text-5xl sm:w-1/3 text-center md:mx-0 font-semibold text-yellow-500">
				Research Narratives
			</h1>
			<br />
		</NavBrand>
		<p class="py-6 px-10 text-yellow-500">
			Research Narratives emerged from a vision to promote responsible data use in research and
			communication. It's a collaborative tool for multidisciplinary writing or research projects
			that convey data patterns
		</p>
...
<footer class="bg-transparent text-black text-left p-10 sm:p-40 grid grid-cols-1 sm:grid-cols-2">
	<div>
