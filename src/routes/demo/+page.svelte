<script>
	...
	import { Drawer, Button, CloseButton, Accordion, AccordionItem } from 'flowbite-svelte';
...
<main>
	<section id="left-bar" class="p-4">
		...
		<Accordion flush>
			<aside id="data-ops">
				<AccordionItem class="bg-primary-50 !py-0" paddingFlush="py-1" padding="p-0">
	...
	<section id="legends">
		<!-- {#key styleChange}
			<Legend bind:uploadedSources={data.data} />
		{/key} -->
	</section>
	...
	>
		...
		<section id="markup" class="">
			...
			<p class="">
				Imagine this to be a mindmap. Draw connections between documents as you go along
			</p>
		</section>

		<ResearchMap bind:supabase={data.supabase} />
	</Drawer>
	<FileUploadModal bind:supabase={data.supabase}/>
</main>
