<script>
	...
	import { loadData } from '$lib/utils/parentRenderer.mjs';
	import { loadLinkData } from '$lib/utils/nonSpatialRenderer.mjs';
...
>
	...
	<section class="text-xs">
		...
		> By continuing to use this alpha prototype, you agree to our usage of the data you upload and narratives
		you create solely for development and research. This data will never be shared with third parties.
	</section>
</Modal>
